...
?>
    <div>
        ...
        <div class="my-2">
            ...
            <h3 class="my-1 text-bold text-grey flex align-center"><?=$data['creator']->first_name . ' ' . $data['creator']->last_name?> 
                <?php if ($data['creator']->is_admin) : ?>
            ...
            <h4 class="my-1 text-grey flex align-center">Uploaded <?=$dataParser->dateTimeToString($data['video']->created_at)?></h4>	
        </div>
